...
from wikibaseintegrator.datatypes import ExternalID, Item, String, Time, URL, MonolingualText
...
wbi_config['USER_AGENT'] = config['DEFAULT']['user'] + \
    ...
    for i, line in enumerate(file_lines):
        ...
        if i > 100 and "tria_url" in lemma:
            ...
            new_lexeme = wbi.lexeme.new(
                lexical_category='Q24905', language="Q36510")
            new_lexeme.lemmas.set(language='el', value=lemma["word"])

            references = [
                [
                    URL(value=unquote(lemma["tria_url"]), prop_nr='P854'),
                    Time(time='+2023-05-02T00:00:00Z', prop_nr='P813',
                         precision=WikibaseDatePrecision.DAY),
                    Item(prop_nr="P407", value="Q36510"),
                    MonolingualText(
                        text='Λεξικό της κοινής νεοελληνικής', language='el', prop_nr="P1476")
                ]
            ]

            claim1 = Item(prop_nr='P1343', value="Q22906367",
